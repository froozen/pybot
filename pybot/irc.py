...
class Irc_server (threading.Thread):
    ...
    def __init__(self, data_container):
        ...
        # Load server config
        self.cofiguration = Configuration_data_container(
            os.path.dirname(__file__) + "/../server_data/%s.config.json" % self.name)
        self.persistent_data = Persistent_data_container(
            os.path.dirname(__file__) + "/../server_data/%s.data.json" % self.name)
    ...
    def _register(self):
        ...
        while True:
            ...
            # Nick already in use
                ...
                log.write("%s: %s already taken, switching to %s_." %
